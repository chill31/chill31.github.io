          ...
          const {
            ...
            p = a(
              `\n      <div :ref="root" class="pickr">\n\n        ${
                ...
                "aria:input"
              )}">\n\n            <input :arr="options" class="pcr-type type-hexa" data-type="HEXA" value="${
                r ? "HEX" : "HEXA"
              }" type="button" ${l(
                e.interaction.hex
              )}>\n            <input :arr="options" class="pcr-type type-rgba" data-type="RGBA" value="${
                r ? "RGB" : "RGBA"
              }" type="button" ${l(
                e.interaction.rgba
              )}>\n            <input :arr="options" class="pcr-type type-hsla" data-type="HSLA" value="${
                r ? "HSL" : "HSLA"
              }" type="button" ${l(
                e.interaction.hsla
              )}>\n            <input :arr="options" class="pcr-type type-hsva" data-type="HSVA" value="${
                r ? "HSV" : "HSVA"
              }" type="button" ${l(
                e.interaction.hsva
