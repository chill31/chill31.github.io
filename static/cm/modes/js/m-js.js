(function (mod) {
  ...
  CodeMirror.defineMode("javascript", function (config, parserConfig) {
    ...
    var keywords = (function () {
      function kw(type) {
        return { type: type, style: "keyword-js" };
      }
      var A = kw("keyword a"),
        B = kw("keyword b"),
        C = kw("keyword c"),
    ...
    function tokenBase(stream, state) {
      ...
      if (ch == '"' || ch == "'") {
        ...
        return ret("number", "number-js");
      } else if (ch == "." && stream.match("..")) {
        return ret("spread", "meta-js");
      } else if (/[\[\]{}\(\),;\:\.]/.test(ch)) {
        return ret(ch);
        ...
        if (stream.eat("*")) {
          ...
          stream.eat("=");
          return ret("operator", "operator-js", stream.current());
        }
      } else if (ch == "`") {
        ...
        stream.skipToEnd();
        return ret("meta", "meta-js");
      } else if (ch == "#" && stream.eatWhile(wordRE)) {
        return ret("variable", "property-js");
      } else if (
        (ch == "<" && stream.match("!--")) ||
        (ch == "-" &&
          stream.match("->") &&
        ...
        if (state.lastType != ".") {
          ...
          if (
            ...
            return ret("async", "keyword-js", word);
        }
        return ret("variable", "variable-js", word);
      }
    }
    ...
    function tokenString(quote) {
      return function (stream, state) {
        ...
        if (
          ...
          return ret("jsonld-keyword", "meta-js");
        }
        while ((next = stream.next()) != null) {
    ...
    function maybeoperatorNoComma(type, value, noComma) {
      ...
      if (type == "regexp") {
        cx.state.lastType = cx.marked = "operator-js";
    ...
    function classNameAfter(type, value) {
      ...
      if (
        ...
        if (value == "implements") cx.marked = "extras-js";
